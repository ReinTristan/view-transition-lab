...
function CalendarDayButton({
  ...
  return (
    <Button
      variant='ghost'
      size='icon'
      // Marcador propio en vez de data-slot: Button esparce {...props} después
      // de su data-slot="button", así que sobrescribirlo dejaría a la celda
      // fuera de las reglas que apuntan a los botones. Con un atributo aparte
      // el tema puede targetear [data-slot='button'][data-calendar-day] y
